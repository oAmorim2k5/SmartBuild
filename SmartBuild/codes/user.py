    ...
    if project_is_open == 1:
        ...
        class MovableLine:
            ...
            def __init__(self, canvas, x1, y1, x2, y2, fill="black", width=2):
                ...
                self.pady2 = self.canvas.coords(self.line)[3]
                self.new_line_list()
            ...
            def new_line_list(self):
                new_obj = {
                    ...
                    "x2": self.canvas.coords(self.line)[3],
                    "width": self.width,
                    "color": self.fill
                }
                objetos.append(new_obj)
...
"""
        ...
        def criar_circulo(canvas, objeto):
            ...
            oval = MovableResizableCircle(canvas, y, x, altura, largura, fill=preenchimento)
        ...
        def criar_linha(canvas, objeto):
            ...
            line = MovableLine(canvas, x, y, 500, y, fill=preenchimento, width=1)
        ...
        softwin.bind("<Up>", move_canvas_down)
        ...
        softwin.bind("<Down>", move_canvas_up)
        ...
        softwin.bind("<Left>", move_canvas_right)
        ...
        softwin.bind("<Right>", move_canvas_left)
